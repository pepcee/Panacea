...
if (isset($_GET['id'])) {
  $product_id = $_GET['id'];
  $stmt = $conn->prepare("SELECT * FROM bestsellers WHERE best_id = ?");
...
<head>
  ...
  <title><?php echo $product['best_name']; ?> | Panacea</title>
  ...
  <main class="product-main">
    <div class="product-container">
      <div class="product-image shadow-xl rounded-lg p-4 bg-white">
        <img src="../<?php echo $product['best_image']; ?>" alt="Featured">
      </div>
      <div class="product-info">
        <h1><?php echo $product['best_name']; ?></h1>
        <p class="subtitle"><?php echo $product['best_tags']; ?></p>
        <p class="price">₱<?php echo $product['best_price']; ?></p>
        ...
        <div class="description">
          ...
          <p><?php echo $product['best_desc']; ?></p>
        </div>
      </div>
    </div>
  </main>
